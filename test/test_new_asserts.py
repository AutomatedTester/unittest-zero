...
class TestNewAsserts:
    ...
    def test_less_fail_string(self):
        try:
            ...
            assert e.msg == '"2" not less than "1", None'
    ...
    def test_less_fail_string_message(self):
        try:
            ...
            assert e.msg == '"2" not less than "1", message'
    ...
    def test_greater_fail_string(self):
        try:
            ...
            assert e.msg == '"1" not greater than "2", None'
    ...
    def test_greater_fail_string_message(self):
        try:
            ...
            assert e.msg == '"1" not greater than "2", message'
    ...
    def test_greater_equal_fail_string(self):
        try:
            ...
            assert e.msg == '"1" not greater than or equal to "2", None'
    ...
    def test_greater_equal_fail_string_message(self):
        try:
            ...
            assert e.msg == '"1" not greater than or equal to "2", message'
    ...
    def test_less_equal_fail_string(self):
        try:
            ...
            assert e.msg == '"2" not less than or equal to "1", None'
    ...
    def test_less_equal_fail_string_message(self):
        try:
            ...
            assert e.msg == '"2" not less than or equal to "1", message'
